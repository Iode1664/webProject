        ...
        <div class="row">
            <div class="col-md-5 ">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('activites.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="col-md-5 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('ajout-activite')); ?>" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>


                            <div class="form-group<?php echo e($errors->has('article') ? ' has-error' : ''); ?>">
                                <label for="article" class="col-md-4 control-label">Article</label>

                                <div class="col-md-6">
                                    <input id="article" type="text" class="form-control" name="article" value="<?php echo e(old('article')); ?>" required autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('prix') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="prix" type="text" class="form-control" name="prix" value="<?php echo e(old('prix')); ?>" required autofocus>
            ...
            <div class="col-md-5 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('ajout-membre')); ?>">
                            <?php echo e(csrf_field()); ?>
